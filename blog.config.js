...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'LZ wiki', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'LZ的专属笔记本📓', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'http://lz.wiki', // 网站地址
